package com.example.quanlychuoicuahangcafe;
...
import com.example.quanlychuoicuahangcafe.Plugins.MapsActivity;
import com.example.quanlychuoicuahangcafe.Plugins.PhongtoAnh;

import com.example.quanlychuoicuahangcafe.Model.QuanCafe;
import com.example.quanlychuoicuahangcafe.Model.monAn;
...
public class DetailCafe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sendEmail = new Intent( DetailCafe.this, com.example.quanlychuoicuahangcafe.Plugins.SendEmail.class);
                Bundle data= new Bundle();
                data.putSerializable("cafe",a);
