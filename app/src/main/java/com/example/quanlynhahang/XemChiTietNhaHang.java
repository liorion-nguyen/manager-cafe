...
import com.example.quanlynhahang.Plugins.MapsActivity;
import com.example.quanlynhahang.Plugins.PhongtoAnh;
...
public class XemChiTietNhaHang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GuiEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent guiemail = new Intent( XemChiTietNhaHang.this, com.example.quanlynhahang.Plugins.GuiEmail.class);
                Bundle data= new Bundle();
                data.putSerializable("nhahang",a);
